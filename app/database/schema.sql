...
INSERT INTO works (name, url, techprocess_id) VALUES ('От ВИО в ФП (НВПиСВ, КСП, АСВ, УСПН, МСК, СПУ)', 'http://127.0.0.1:5555/resend/person_apply_application_request', 1);

INSERT INTO works (name, url, techprocess_id) VALUES ('Переотправка в АСВ по пакетам ЕФС-1', 'http://127.0.0.1:5555/resend/upp_efs', 2);
INSERT INTO works (name, url, techprocess_id) VALUES ('Переотправка в АСВ по пакетам ИС', 'http://127.0.0.1:5555/resend/upp_is', 2);
INSERT INTO works (name, url, techprocess_id) VALUES ('Переотправка в АСВ по пакетам СЗВ-М', 'http://127.0.0.1:5555/resend/upp_szvm', 2);
INSERT INTO works (name, url, techprocess_id) VALUES ('Переотправка атомарок', 'http://127.0.0.1:5555/resend/efs_atom_retry_tool', 2);
INSERT INTO works (name, url, techprocess_id) VALUES ('Переотправка в СПУ', 'http://127.0.0.1:5555/resend/upp_resend_files_efs_to_spuefs', 2);
INSERT INTO works (name, url, techprocess_id) VALUES ('Переотправка СЗИ-КМ в ФБДП', 'http://127.0.0.1:5555/resend/szi_km_to_fbdp', 2);

INSERT INTO works (name, url, techprocess_id) VALUES ('Переотправка в НВП (По инициативке)', 'http://127.0.0.1:5555/resend/vmse_proactive', 3);
INSERT INTO works (name, url, techprocess_id) VALUES ('Переотправка в НВП (По запросу)', 'http://127.0.0.1:5555/resend/vmse_zapros', 3);

INSERT INTO works (name, url, techprocess_id) VALUES ('Переотправка в АСВ', 'http://127.0.0.1:5555/resend/egrn_egrul_egrip', 4);
INSERT INTO works (name, url, techprocess_id) VALUES ('Переотправка в ЕХД', 'http://127.0.0.1:5555/resend/resend_files_egrn_egrip_egrul', 4);

INSERT INTO works (name, url, techprocess_id) VALUES ('Переотправка в УСПН', 'http://127.0.0.1:5555/resend/npf_doc_uspn', 5);

INSERT INTO works (name, url, techprocess_id) VALUES ('Переотправка РНПП в НВП', 'http://127.0.0.1:5555/resend/resend_rnpp', 6);
INSERT INTO works (name, url, techprocess_id) VALUES ('Переотправка ПОСЗН в НВП', 'http://127.0.0.1:5555/resend/resend_poszn', 6);

INSERT INTO works (name, url, techprocess_id) VALUES ('Переотправка АДИ-Рег/АДИ-8', 'http://127.0.0.1:5555/resend/resend_adv_adi', 7);

INSERT INTO works (name, url, techprocess_id) VALUES ('Переотправка файлов', 'http://127.0.0.1:5555/resend/resend_files', 8);
INSERT INTO works (name, url, techprocess_id) VALUES ('Переотправка файлов в СОЭ', 'http://127.0.0.1:5555/resend/resend_files_soe', 8);

INSERT INTO works (name, url, techprocess_id) VALUES ('Смена статуса', 'http://127.0.0.1:5555/resend/change_status', 9);

INSERT INTO works (name, url, techprocess_id) VALUES ('Поиск СЗВ-Запроса по messageID', 'http://127.0.0.1:5555/resend/get_szv_zapros', 10);
INSERT INTO works (name, url, techprocess_id) VALUES ('Переотправка СЗИ-СВ в НВП', 'http://127.0.0.1:5555/resend/szi_sv_to_nvp', 10);
